emiya_unlimited_blade_works = class({})
...
function emiya_unlimited_blade_works:GetBuffDuration()
...
function emiya_unlimited_blade_works:GetUBWCastCount()
    local caster = self:GetCaster()
...
function emiya_unlimited_blade_works:GrantUBWChantBuff()
    local caster = self:GetCaster()
    local ability = self
...
function emiya_unlimited_blade_works:ReduceAbilityCooldowns()
    local caster = self:GetCaster()
...
function emiya_unlimited_blade_works:OnSpellStart()
...
function emiya_unlimited_blade_works:StartUBW()
    local caster = self:GetCaster()
...
function emiya_unlimited_blade_works:EnterUBW()
...
function emiya_unlimited_blade_works:EndUBW()   
...
function emiya_unlimited_blade_works:SwitchAbilities(isUbw)
    local caster = self:GetCaster()
...
function emiya_unlimited_blade_works:OnOwnerDied()
...
function emiya_unlimited_blade_works:CheckCombo()
    local caster = self:GetCaster()
...
function emiya_unlimited_blade_works:OnUpgrade()
    local caster = self:GetCaster()
    local ability = self
...
function emiya_unlimited_blade_works:GetCastAnimation()
    return ACT_DOTA_CAST_ABILITY_4
end

function emiya_unlimited_blade_works:GetAbilityTextureName()
