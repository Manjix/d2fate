...
function lishuwen_tiger_strike:OnUpgrade()
	local caster = self:GetCaster()
	local ability = self

	--[[if IsServer() then
		if not caster.StartTigerStrikeCooldown then 
			function caster:StartTigerStrikeCooldown(...)
				ability:StartTigerStrikeCooldown(...)
			end
		end
	end]]
end

--[[function lishuwen_tiger_strike:StartTigerStrikeCooldown(table)
	print(table)
